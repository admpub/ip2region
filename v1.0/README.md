...
```
**由于原作者繁忙很久没有更新IP数据库了,但是这个数据库几乎每天都在变,很多需要用的朋友也是干着急啊包括我,所以更新数据库的重任就让我举手之劳的扛起来吧,以后我会保持每月更新一次的频率为大家提供最新的IP库查询.**

数据来源为付费来源,包括GEOIP,阿里和一些其他付费平台,如果你有渠道请告诉我

拜托大家把star点起来让需要使用的朋友能及时拿到最新的更新包,如有错误请及时提issues,我会及时同步更新至线上库

如大家谁手上有最新的库也可以发我来一块合并,让我们共同维护这个项目,thanks!!

**数据库改动了一个地方,原area显示的是华南华北华东等等,现在换成了亚洲,欧洲等所属大洲**
